...
for feature in geojson_data['features']:
    name_vi = feature['properties'].get('name:en', 'Unnamed region')
...
people_file_path = 'input_data/PEOPLE_OLD.csv'
...
output_map = 'output_map_input.html'
m.save(output_map)
